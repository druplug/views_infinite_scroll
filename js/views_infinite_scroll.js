          ...
          if(!use_ajax) {
            ...
            var handle = $.autopager({
              ...
              load: function() {
                ...
                var div_settings = Drupal.settings.viewsFluidGrid['views_fluidgrid_' + settings.view_name + '_' + settings.display];
                $('.views-fluidgrid-item').css('width',parseInt(div_settings.columnWidth));
                $('.views-fluidgrid-item-inner').css('margin',parseInt(div_settings.gutterWidth));
